...
const SEARCH_ITEMS = [
  ...
  { label: "Hotels", href: "/accommodations?type=hotel", category: "Services" },
  { label: "Airbnbs", href: "/accommodations?type=airbnb", category: "Services" },
  { label: "Taxi", href: "/accommodations?type=taxi", category: "Services" },
